...
1. [The Five Tastes](#1-the-five-tastes)
2. [The Balance Principle](#2-the-balance-principle)
3. [Cocktail Family Classification](#3-cocktail-family-classification)
4. [Recipe Design Framework](#4-recipe-design-framework)
5. [Flavor Wheel & Pairing Reference](#5-flavor-wheel--pairing-reference)
...
A well-made cocktail typically contains **15-25% water** (from ice melt). Proper dilution:
- Reduces the burn of alcohol
- Helps flavors integrate and harmonize
- Makes the cocktail more "drinkable"
...
Choose based on the flavor direction you want:
- Clean and crisp → Vodka or white rum
- Botanical and aromatic → Gin
- Warm and mellow → Bourbon or rye
- Spicy and distinctive → Tequila
...
Make a test pour and adjust based on the five-taste principles:
- Too sweet? Add acid.
- Too sour? Add sweetener.
- Too simple? Add a dash of bitters or a tiny amount of salt.
